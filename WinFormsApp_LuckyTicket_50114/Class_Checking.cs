...
namespace WinFormsApp_LuckyTicket_50114
{
    public class Class_Parsing
    {
        ...
        public static string ConvertLongToString(long lg_value, short
    sh_num_of_digits)
        {
            string str_return = "";
            string str = lg_value.ToString();
    ...
    public class Class_Evaluating
    {
        ...
        //‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐‐ 
        /// <summary>
        /// Проверка билета по индивидуальному заданию
        /// </summary>
        /// <param name="arr"> получает массив элементов типа char, в котором находится заданный билет</param>
        /// <returns>возвращает константу типа short, содержащий счастливый или обычный билет</returns>
        private static short RevealLucky_Task(short[] arr)
        {
            short iter = 0;
            for (; iter <= 3; iter++)
            {
                if (((arr[iter] == 5 && arr[iter+1] == 0 && arr[iter+2] == 1)))
                {
                    return DEF_LUCKY_TICKET;
                }
            }
